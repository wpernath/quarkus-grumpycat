	...
	patchSystemFn() {
		...
		me.plugin.patch(me.Renderable, "postDraw", function (renderer) {
			...
			if (_this.visible) {
				...
				if (!(this instanceof me.Entity) && !(this instanceof me.Text) && !(this instanceof me.BitmapText) && !(this instanceof me.Camera2d) && !(this instanceof me.ImageLayer)) {
			...
			if (_this.visible) {
				...
				if (_this.checkbox.renderHitBox.selected) {
					...
					if (this.renderable instanceof me.Renderable) {
						renderer.translate(-this.anchorPoint.x * this.body.getBounds().width, -this.anchorPoint.y * this.body.getBounds().height);
					}

					renderer.translate(this.pos.x + this.ancestor.getAbsolutePosition().x, this.pos.y + this.ancestor.getAbsolutePosition().y);
